...
class AnimatedPhoneTextFormField extends StatefulWidget {
  AnimatedPhoneTextFormField({
    Key? key,
    this.interval = const Interval(0.0, 1.0),
    required this.animatedWidth,
    this.loadingController,
  ...
  @override
  _AnimatedPhoneTextFormFieldTextFormFieldState createState() =>
      _AnimatedPhoneTextFormFieldTextFormFieldState();
}

class _AnimatedPhoneTextFormFieldTextFormFieldState
    extends State<AnimatedPhoneTextFormField> {
