...
class LoginMessages with ChangeNotifier {
  LoginMessages(
      ...
      this.confirmPasswordHint = defaultConfirmPasswordHint,
        ...
        this.fatherPhoneNumberHint = defaultfatherPhoneNumberHint,
        this.phoneError = defaultPhoneError,
        this.fatherPhoneError = defaultfatherPhoneError,
  ...
  static const defaultfatherPhoneNumberHint = 'Father Phone Number';
  ...
  static const defaultPhoneError = 'Please Enter Phone Number';
  static const defaultfatherPhoneError = 'Please Enter Father Phone Number';
  ...
  /// Hint text of the phoneNumberHint [TextField]
  final String phoneNumberHint;

  /// Hint text of the fatherPhoneError [TextField]
  final String fatherPhoneError;

  /// Hint text of the fatherPhoneNumberHint [TextField]
  final String fatherPhoneNumberHint;
